...
| **Abuse and cost containment** | If we’re “trusted,” attackers will test us. Rate limiting and per-tenant caps must be real. | Ensure **rate limiting** (already in place) + **per-tenant caps** (usage_daily, plan limits) + **anomaly alerts** (e.g. spike in 401/403, burst of failed webhooks) ship alongside SLOs. Document in ALERTS and OPERATIONS. |
...
- **Related:** `docs/IMPROVEMENT_PLAN.md`; `docs/PROD_SETUP_CHECKLIST.md`; `docs/OBSERVABILITY.md`; `docs/ALERTS.md`; `docs/SECURITY.md`; `docs/IDENTITY_TENANCY.md`; `docs/TRUST.md` (Trust entry point); `docs/DASHBOARD_SESSION_DESIGN.md` (optional)
